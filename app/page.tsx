...
import { ArrowRight, Play, Calendar, Heart, Users, Zap, Baby, Globe, Music, Gift, BookOpen, ChevronRight } from "lucide-react";
    ...
    <div>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-5">
            <div className="lg:col-span-3 animate-slide-up">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Button asChild size="lg" className="rounded-full bg-foreground px-10 text-lg text-background hover:bg-foreground/90 hover:scale-105 transition-transform">
                  <Link href="/visit">
                    Plan Your Visit
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="rounded-full border-2 border-foreground px-10 text-lg text-foreground hover:bg-foreground hover:text-background hover:scale-105 transition-transform"
                >
                  <Link href="/sermons">
      ...
      <section className="bg-background py-24 lg:py-32 animate-fade-in">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <p className="text-sm font-medium uppercase tracking-[0.3em] text-accent">New Here?</p>
              <h2 className="mt-3 font-serif text-4xl font-bold text-foreground md:text-5xl">Welcome to Our Church</h2>
            </div>
            <p className="max-w-md text-lg leading-relaxed text-muted-foreground lg:text-right">
              Whether you are visiting for the first time or looking for a church home, we are so glad you are here.
            </p>
          </div>
          <div className="mt-16 grid gap-6 sm:grid-cols-3">
            {[
              { title: "Visit Us", desc: "Join us for a Sunday service at 3:00 PM. We would love to meet you and make you feel at home.", img: "https://images.unsplash.com/photo-1438032005730-c779502df39b?w=600&q=80" },
              { title: "Get Connected", desc: "Find a ministry or small group that fits your season of life. There is a place for everyone here.", img: "https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=600&q=80" },
              { title: "Grow Together", desc: "Deepen your faith through teaching, fellowship, and serving alongside our church family.", img: "https://images.unsplash.com/photo-1529070538774-1843cb3265df?w=600&q=80" },
            ].map((item) => (
              <div key={item.title} className="group overflow-hidden rounded-2xl bg-background shadow-lg transition-all hover:shadow-xl hover:scale-105">
                <div className="relative h-48 overflow-hidden">
                  <img src={item.img} alt={item.title} className="h-full w-full object-cover transition-transform group-hover:scale-110" />
        ...
        <section className="border-y border-border bg-foreground py-16 lg:py-20 animate-fade-in">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="flex flex-col items-start justify-between gap-8 sm:flex-row sm:items-center">
              ...
              <Button asChild className="rounded-full border-2 border-background/20 bg-background px-10 text-lg text-foreground hover:bg-background/90 hover:scale-105 transition-transform">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-12 lg:grid-cols-5">
            ...
            <div className="flex flex-col justify-center lg:col-span-2">
              ...
              <div className="mt-8">
                <Button asChild className="rounded-full bg-foreground px-10 text-lg text-background hover:bg-foreground/90 hover:scale-105 transition-transform">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {featuredMinistries.map((ministry) => {
              ...
              return (
                <Link key={ministry.slug} href={`/ministries/${ministry.slug}`} className="group rounded-2xl bg-background p-8 shadow-md transition-all hover:shadow-xl hover:scale-105 lg:p-10">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-3">
            {testimonies.slice(0, 3).map((testimony, i) => (
              <div key={i} className="rounded-2xl bg-gradient-to-br from-accent/5 to-accent/10 p-8 shadow-md transition-all hover:shadow-xl lg:p-10">
      ...
      <section className="border-y border-border bg-foreground py-24 lg:py-32 animate-fade-in">
        <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
          ...
          <div className="mt-10">
            <Button asChild size="lg" className="rounded-full border-2 border-background/20 bg-background px-12 text-lg text-foreground hover:bg-background/90 hover:scale-105 transition-transform">
              <Link href="/give">
                Give Now
                <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
